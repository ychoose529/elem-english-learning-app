...
class _HomePageState extends State<HomePage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text("🎈 國小英文聽說讀寫樂園", style: TextStyle(fontWeight: FontWeight.bold)),
        centerTitle: true,
          ...
          children: [
            ...
            Row(
              ...
              children: [
                ElevatedButton.icon(
                  ...
                  label: const Text("聽發音"),
                  style: ElevatedButton.styleFrom(backgroundColor: Colors.lightBlue),
                ),
                ElevatedButton.icon(
                  onPressed: _listen,
                  icon: Icon(_isListening ? Icons.mic : Icons.mic_none),
                  label: Text(_isListening ? "錄音中..." : "練習說"),
                  style: ElevatedButton.styleFrom(backgroundColor: _isListening ? Colors.redAccent : Colors.green),
                ),
              ],
            ),
            if (_spokenText.isNotEmpty)
              Padding(
                ...
                child: Text("你說的是：$_spokenText", style: const TextStyle(color: Colors.blueGrey)),
              ),
            const SizedBox(height: 15),
            Card(
              child: Padding(
